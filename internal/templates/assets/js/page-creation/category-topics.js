...
function buildTopic(topic) {
  ...
  const lastPost = topic.post_list[0];
 ...
 <div class="topic-content">   
    <div class="topic-open">Ouvert le ${topic.created_on} par ${topic.author}</div>

    <div class="topic-lastinfo"><div class="topic-image"><img src="/assets/images-avatar/${lastPostImage}.png"/></div>
    ...
    <button type="button" class="button-link" data_id="${postID}" style="float:right;margin-top:-5px">
                  ...
                  />
                </button> Dernier message le ${lastPostDate} par ${lastPostAuthor}</div>
 </div>`;
  }
